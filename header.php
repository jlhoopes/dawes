...
<html>
	<head>
		<title>J&L Professional Services LLC.</title>
		<!--meta-->
		<meta charset="UTF-8" />
				...
				<div class="header-top-bar">
					<ul class="contact-details clearfix">
						<li class="template-phone">
							<a href="tel:+16144001996">+1(614) 400-1996</a>
						</li>
						<li class="template-mail">
							<a href="mailto:inquiries@dawesitright.com">inquiries@dawesitright.com</a>
						</li>
					...
					<ul class="social-icons">
						<li>
							<a target="_blank" href="http://facebook.com/jandlprofessionalservicesllc" class="social-facebook" title="facebook"></a>
						</li>
						<li>
							<a target="_blank" href="https://twitter.com/jandlprofessionalservicesllc" class="social-twitter" title="twitter"></a>
						</li>
						<li>
							<a href="https://pinterest.com/jandlprofessionalservicesllc/" class="social-pinterest" title="pinterest"></a>
						</li>
						<!--<li>
							<a title="" href="#" class="social-google-plus"></a>
						</li>
						<li>
							<a title="" href="#" class="social-youtube"></a>
						</li>
						<li>
							<a title="" href="#" class="social-linkedin"></a>
						</li>
						<li>
							<a title="" href="#" class="social-pinterest"></a>
						</li>
						<li>
							<a title="" href="#" class="social-dribble"></a>
						</li>
						<li>
							<a title="" href="#" class="social-skype"></a>
						</li>
						<li>
							<a title="" href="#" class="social-tumblr"></a>
						</li>
						<li>
							<a title="" href="#" class="social-instagram"></a>
						</li>
						<li>
							<a title="" href="#" class="social-xing"></a>
						</li>
						<li>
							<a title="" href="#" class="social-foursquare"></a>
						</li>
						<li>
							<a title="" href="#" class="social-rss"></a>
						</li>
						<li>
							<a title="" href="#" class="social-behance"></a>
						</li>
						<li>
							<a title="" href="#" class="social-picasa"></a>
						</li>
						<li>
							<a title="" href="#" class="social-stumbleupon"></a>
						</li>
						<li>
							<a title="" href="#" class="social-vimeo"></a>
						</li>
						<li>
							<a title="" href="#" class="social-houzz"></a>
						</li>
						<li>
							<a title="" href="#" class="social-yelp"></a>
						</li>
						<li>
							<a title="" href="#" class="social-github"></a>
						</li>
						<li>
							<a title="" href="#" class="social-reddit"></a>
						</li>
						<li>
							<a title="" href="#" class="social-soundcloud"></a>
						</li>
						<li>
							<a title="" href="#" class="social-vk"></a>
						</li>
						<li>
							<a title="" href="#" class="social-vine"></a>
						</li>
						-->
					</ul>
				</div>
