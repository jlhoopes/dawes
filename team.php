		...
		<div class="row">
			<div class="team-list-center">
				<ul class="team-list padding-top-70 clearfix">
					<li class="team-box">
						<a href="?page=team_jeff_dawes" title="Jeff Dawes">
						...
						<ul class="social-icons">
							<li><a title="" target="_blank" href="http://facebook.com/jeffdawes" class="social-facebook">&nbsp;</a></li>
							<li><a title="" target="_blank" href="http://twitter.com/jeffdawes" class="social-twitter">&nbsp;</a></li>
							<li><a title="" target="_blank" href="http://linkedin.com/jeffdawes" class="social-linkedin">&nbsp;</a></li>
						</ul>
					</li>
					<li class="team-box">
						<a href="?page=team_lori_dawes" title="Lori Dawes">
							<img alt="Lori Dawes" src="images/samples/390x260/team_02.png">
						</a>
						<div class="team-content">
							<h4 class="box-header">
								<a href="?page=team_lori_dawes" title="Lori Dawes">Lori Dawes</a>
								<span>CO-FOUNDER</span>
							</h4>
							<p>Primus elite lectus tical at node. Porta commodo terminal forks sande. Nulla novum at novelle.</p>
						</div>
						<ul class="social-icons">
							<li><a title="" target="_blank" href="http://facebook.com/loridawes" class="social-facebook">&nbsp;</a></li>
							<li><a title="" target="_blank" href="https://www.pinterest.com/loridawes/" class="social-pinterest">&nbsp;</a></li>
							<li><a title="" target="_blank" href="https://dribbble.com/loridawes" class="social-dribble">&nbsp;</a></li>
						</ul>
					</li>
				</ul>
			</div>
