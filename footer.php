					...
					<div class="column column-1-3">
						<ul class="contact-details-list">
							<li class="sl-small-mail">
								<p>E-mail:<br>
								<a href="mailto:inquiries@dawesitright.com">inquiries@dawesitright.com</a></p>
							</li>
						</ul>
					</div>
				</div>
				...
				<div class="row row-4-4">
					<div class="column column-1-4">
						...
						<ul class="social-icons yellow margin-top-26">
							...
							<li>
								<a target="_blank" href="https://linkedin.com/jandlprofessionalservicesllc" class="social-linkedin" title="linkedin"></a>
							</li>
							<li>
