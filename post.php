					...
					<div class="post single">
						...
						<div class="post-content">
							...
							<div class="row padding-top-54 padding-bottom-17">
								<a class="more scroll-to-comment-form" href="?page=post" title="LEAVE A REPLY">LEAVE A REPLY</a>
							</div>
						</div>
					</div>
				</div>
				<div class="row page-margin-top">
					<h3 class="box-header">LEAVE A COMMENT</h3>
					<form class="comment-form margin-top-40" id="comment-form" method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>">
						...
						<div class="row margin-top-30">
							<div class="column column-1-2">
								<p class="description t1">You comment will be published within 24 hours.</p>
							</div>
