			...
			<li data-transition="fade" data-masterspeed="500" data-slotamount="1" data-delay="6000">
				...
				<div class="tp-caption"
					...
					<div class="slider-content-box">
						...
						<a target="_top" class="more simple" href="?page=service_design_build" title="Home Improvements">More Info</a>
					</div>
				</div>
			</li>
			...
			<li data-transition="fade" data-masterspeed="500" data-slotamount="1" data-delay="6000">
				...
				<div class="tp-caption"
					...
					<div class="slider-content-box">
						...
						<a target="_top" class="more simple" href="?page=service_tiling_painting" title="Tiling & Painting">More Info</a>
					</div>
				</div>
			</li>
			...
			<li data-transition="fade" data-masterspeed="500" data-slotamount="1" data-delay="6000">
				...
				<div class="tp-caption"
					...
					<div class="slider-content-box">
						...
						<a target="_top" class="more simple" href="?page=service_household_repairs" title="Household Repairs">More Info</a>
					</div>
				</div>
			</li>
		</ul>
	...
	<div class="clearfix">
		...
		<div class="row full-width gray flex-box page-margin-top-section">
			<div class="column column-1-3 padding-left-right-100 padding-bottom-50">
				...
				<p class="description t1 margin-top-34">Founded by Jeff Dawes back in 2000, J&L Professional Services has established itself as one of the greatest<br>
		...
		<div class="row page-margin-top-section">
			<div class="row">
				...
				<p class="description align-center">Founded by Jeff Dawes back in 2000, J&L Professional Services has established itself as one of the greatest and prestigous<br> providers of construction focused interior renovation services and building.</p>
			</div>
			...
			<div class="column column-1-2">
				...
				<div class="row testimonials-container type-small margin-top-40">
					...
					<ul class="testimonials-list autoplay-1 pause_on_hover-1">
						<li>
							<p>"We would like to thank J&L Professional Services Company for an outstanding effort on this
		...
		<div class="row full-width gray page-padding-top-section page-margin-top-section padding-bottom-70">
			<div class="row">
				...
				<ul class="team-list page-margin-top clearfix">
					<li class="team-box">
						<a href="?page=team_mark_whilberg" title="Jeff Dawes">
							<img alt="Jeff Dawes" src="images/samples/390x260/team_01.png">
						</a>
						<div class="team-content">
							<h4 class="box-header">
								<a href="?page=team_jeff_dawes" title="Jeff Dawes">Jeff Dawes</a>
								<span>CO-FOUNDER</span>
							</h4>
							<p>Primus elite lectus tical at node. Porta commodo terminal forks sande. Nulla novum at novelle.</p>
						</div>
						<ul class="social-icons">
							<li><a title="" target="_blank" href="http://facebook.com/jandlprofessionalservicesllc" class="social-facebook">&nbsp;</a></li>
							<li><a title="" target="_blank" href="http://twitter.com/jandlprofessionalservicesllc" class="social-twitter">&nbsp;</a></li>
							<li><a title="" target="_blank" href="http://linkedin/jandlprofessionalservicesllc" class="social-linkedin">&nbsp;</a></li>
						</ul>
					</li>
					<!--
					<li class="team-box">
