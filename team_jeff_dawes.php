		...
		<div class="row page-margin-top-section">
			<div class="column column-1-3">
				<div class="team-box single">
					...
					<div class="team-content">
						<h4>
							<a href="?page=team_mark_whilberg" title="Mark Whilberg">Jeff Dawes</a>
							<span>CO-FOUNDER</span>
						</h4>
					</div>
					<ul class="social-icons">
						<li><a title="" target="_blank" href="https://www.facebook.com/profile.php?id=100009226763761" class="social-facebook">&nbsp;</a></li>
			...
			<div class="column column-1-3">
				...
				<table class="margin-top-40 align-left">
					<tbody>
						<tr>
							<td>Name: Jeff Dawes</td>
						</tr>
						<tr>
							<td>Address: 272 Linden Avenue, Winter Park</td>
						</tr>
						<tr>
							<td>Email: <a href="mailto:jeff@dawesitright.com">jeff@dawesitright.com</a></td>
						</tr>
						<tr>
							<td>Phone: +1 (614) 400-1996</td>
						</tr>
					</tbody>
				</table>
			</div>
			...
			<div class="column column-2-3">
				...
				<div class="timeline-item vertical-align-table margin-top-40">
					...
					<div class="timeline-content vertical-align-cell">
						<h4 class="clearfix">
							<span class="timeline-title">xxx CONSTRUCT</span><span class="timeline-subtitle">DIGGER OPERATOR</span>
						</h4>
