			...
			<li data-transition="fade" data-masterspeed="500" data-slotamount="1" data-delay="6000">
				...
				<div class="tp-caption"
					...
					<div class="slider-content-box">
						...
						<a target="_top" class="more simple" href="?page=service_tiling_painting" title="Tiling and Painting">More Info</a>
					</div>
				</div>
			</li>
...
<div class="theme-page">
	<div class="clearfix">
		...
		<div class="row page-margin-top-section padding-bottom-66">
			<h2 class="box-header">WHY CHOOSE J&L Professional Services</h2>
			<p class="description align-center">Founded by Jeff Dawes back in 2000, J&L Professional Services has established itself as one of the greatest and prestigious<br>providers of construction focused interior renovation services and building.</p>
			<div class="row page-margin-top">
